...
export default function LeaderboardPage() {
  ...
  return (
    <main className="h-screen bg-black text-white p-4 flex flex-col">
      <div className="max-w-4xl mx-auto flex-1 flex flex-col h-full">
        <div className="flex items-center justify-between mb-6 border-b border-neon-cyan/30 pb-4">
          <div>
            <h1 className="text-3xl font-bold text-neon-yellow drop-shadow-[0_0_10px_#ffff00]">
              {t("leaderboardTitle")}
            </h1>
            {user && (
        ...
        <div className="mb-4 flex items-center gap-4 flex-wrap">
          ...
          <label className="text-neon-cyan/80">
            {t("filterMode") || "模式"}:
          </label>
          <select
            value={selectedMode}
                ...
                <table className="w-full">
                  <thead className="sticky top-0 z-10 bg-gray-800">
                    <tr className="border-b border-neon-cyan/30">
                      <th className="px-2 py-3 text-left w-14 text-neon-cyan">
                        {t("rank")}
                      </th>
                      <th className="px-2 py-3 text-right text-neon-cyan min-w-[80px]">
                        {t("score")}
                      </th>
                      <th className="px-2 py-3 text-center text-neon-cyan min-w-[100px]">
                        {t("map")}
                      </th>
                      <th className="px-2 py-3 text-center w-20 text-neon-cyan">
                        {t("mode") || "模式"}
                      </th>
                      <th className="px-2 py-3 text-center w-40 text-neon-cyan">
                        {t("email")}
                      </th>
                      <th className="px-2 py-3 text-right hidden lg:table-cell w-32 text-neon-cyan">
                        {t("date")}
                      </th>
                    </tr>
                  </thead>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-2 py-3 text-center text-sm min-w-[100px]">
                            <span
                              className="inline-block max-w-[150px] px-2 py-1 bg-black/60 border border-neon-cyan/30 rounded text-neon-cyan/80 truncate"
                              title={entry.mapName || t("defaultMap")}
                            >
